...
import (
	...
	v1 "kubebuilder-webhook-core-types/api/v1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "78e545c5.github.com",
	})
	if err != nil {
	...
	mgr.GetWebhookServer().Register("/mutate-core-v1-pod", &webhook.Admission{Handler: pv})
